...
<body id="dashadmin" style="background-image: url('images/admin1.jpg'); background-repeat: no-repeat;background-size: cover;">
  <header>
...
<h1 class="text-center Admin">ADMINISTRATOR DASHBOARD</h1>
