...
<h1 class="text-center">Goat Feeds </h1>
...
$conn= mysqli_connect("localhost", "root", "", "market_db");
             if (!$conn) {
                ...
                $sql = "SELECT `ProductID`, `productName`, `Type`, `productImage`, `Description`, `Contact_Info` FROM `feedsale_tbl` WHERE `Type` = 'Goat Feeds'";
...
echo "</div>";
         ...
         echo "No Goat Feeds Currently on Sale";
      }
