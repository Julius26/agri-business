...
<h1 class="text-center">Pig Feeds </h1>
...
$conn= mysqli_connect("localhost", "root", "", "market_db");
             if (!$conn) {
                ...
                $sql = "SELECT `ProductID`, `productName`, `Type`, `productImage`, `Description`, `Contact_Info` FROM `feedsale_tbl` WHERE `Type` = 'Pig Feeds'";
...
echo "</div>";
         ...
         echo "No Pig Feeds Currently on Sale";
      }
