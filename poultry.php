...
<h1 class="text-center">Poultry Feeds </h1>
...
$conn= mysqli_connect("localhost", "root", "", "market_db");
             if (!$conn) {
                ...
                $sql = "SELECT `ProductID`, `productName`, `Type`, `productImage`, `Description`, `Contact_Info` FROM `feedsale_tbl` WHERE `Type` = 'Poultry Feeds'";
...
echo "</div>";
         ...
         echo "No Poultry Feeds Currently on Sale";
      }
