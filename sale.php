...
<form method="POST" class="form-group" enctype="multipart/form-data">
	...
	<input type="text" name="Business_Number" class="form-control" placeholder="Enter business number">
	<br/>
	<br/> -->
  ...
  <option >Poultry Feeds</option>
  <option >Sheep Feeds</option>
  ...
  <option >Pig Feeds</option>
	...
	<textarea name="Description" class="form-control" rows="5" cols="5" placeholder="Please Enter a brief Description">
	</textarea>
  <br/>
	<br/>
  <label>Contact_Info</label>
  <input type="text" name="Contact_Info" class="form-control" placeholder="Enter Your Contact information">
  <br/>
  <br/>
...
if(move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $target_path)) {
  ...
  $URL = "http://localhost:8000/Marketing/uploads/".basename( $_FILES['uploadedfile']['name']);
  //print($URL);
  ...
  $Contact_Info = $_POST['Contact_Info'];
	...
	if (!$con) {
		die("connection failed:".mysqli_connect_error());
			...
			$sql ="INSERT INTO `feedsale_tbl`(`ProductID`, `productName`, `Type`, `productImage`, `Description`, `Contact_Info`) VALUES  ( '$ProductID', '$ProductName', '$Type', '$URL', '$Description', '$Contact_Info')";
