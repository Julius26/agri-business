...
<h1 class="text-center">Sheep Feeds</h1>
...
$conn= mysqli_connect("localhost", "root", "", "market_db");
             if (!$conn) {
                ...
                $sql = "SELECT `ProductID`, `productName`, `Type`, `productImage`, `Description`, `Contact_Info` FROM `feedsale_tbl` WHERE `Type` = 'Sheep Feeds'";
...
echo "</div>";
         ...
         echo "No Sheep Feeds Currently on Sale";
      }
